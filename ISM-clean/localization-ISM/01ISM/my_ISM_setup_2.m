function [SetupStruc] = my_ISM_setup_2(x,y,z)
%20190310修改，改动房间尺寸，麦克风位置，吸收系数以及T60
...
SetupStruc.room = [7  6  3];        % room dimensions in m

SetupStruc.mic_pos = [4.15  2.5  1.2];    % [x y z] positions of a microphone array in m
                     

SetupStruc.src_traj = [x  y  z];
...
SetupStruc.T60 = 0.3;                 % reverberation time T60, or define a T20 field instead!
% SetupStruc.T20 = 0.15;                % reverberation time T20, or define a T60 field instead!

SetupStruc.abs_weights = [0.81  0.81  0.81  0.81  0.81  0.81];    % (optional) weights for the resulting alpha coefficients.
